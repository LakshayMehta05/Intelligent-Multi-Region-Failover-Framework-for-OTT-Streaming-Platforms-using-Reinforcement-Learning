"""
Train PPO on StreamFailoverEnv using REAL 5G trace data
(UCC 5G production dataset, recorded during real Netflix streaming).
Uses VecNormalize since PPO is sensitive to input/reward scale.
"""
...
MODEL_DIR = "results/ppo_realdata_model"
LOG_DIR = "results/ppo_realdata_logs"
